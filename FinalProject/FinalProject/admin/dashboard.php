...
/* Inner Overlay to keep content clean */
.stat-card::after {
    content: "";
    position: absolute;
    inset: 3px;
...
.stat-number {
    ...
    /* --- ICON PARA SA STATISTICS CARD (Ito lang ang idadagdag mo) --- */

/* Hahanapin natin yung `.stat-card` na nasa loob ng `.stats-link` */
.stats-link .stat-card .stat-number::after {
    content: "📊"; /* Ilalagay ang Emoji icon */
    font-size: 55px; /* Laki ng icon */
    display: block; /* Para nasa gitna */
    margin-top: -10px; /* Kaunting adjustment sa taas */
    text-shadow: 0 0 20px rgba(46,204,113,0.5); /* Glowing effect para Supreme */
}

/* Add icon for Statistics card visually */
.stat-card.stats-link .stat-number::after {
    content: "📊";
    font-size: 50px;
}
...
<div class="container">
    ...
    <div class="stats-grid">
        <a href="statistics.php" style="text-decoration: none; color: inherit;" class="stats-link">
            <div class="stat-card">
                <div class="stat-title">View Statistics</div>
