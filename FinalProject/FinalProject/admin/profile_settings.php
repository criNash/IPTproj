...
if(isset($_POST['update'])){
    ...
    if($newUsername !== $currentAdmin){
        $sql = "UPDATE admin_users SET username='$newUsername' WHERE username='$currentAdmin'";
        if(mysqli_query($conn,$sql)){
            $_SESSION['admin'] = $newUsername;
            echo "<script>alert('Username updated successfully!'); window.location='dashboard.php';</script>";
        } else {
            echo "<script>alert('Update failed. Please try again.');</script>";
        }
    } else {
        echo "<script>alert('New username cannot be same as current username');</script>";
    }
}
?>
<!DOCTYPE html>
...
<title>Profile Settings | Budget Supreme</title>
...
<div class="main-wrapper">
    <div class="form-card">
        ...
        <div class="form-content">
            ...
            <form method="POST" onsubmit="return confirm('Confirm username change?');">
                <div class="input-group">
                    <input type="text" value="<?php echo $_SESSION['admin']; ?>" readonly placeholder=" ">
                    <label>Current Username</label>
                </div>
                <div class="input-group">
                    <input type="text" name="new_username" required placeholder=" ">
                    <label>New Username</label>
                </div>
                <div class="btn-group">
                    <button type="submit" name="update" class="btn-base btn-update">Commit</button>
